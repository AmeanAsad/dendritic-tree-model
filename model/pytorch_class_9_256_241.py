...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv3 = CausalConv1d(in_channels = 512, out_channels = 500, kernel_size = 7, stride = (1,) , dilation = 1, groups = 1, bias = True)
        self.conv4 = CausalConv1d(in_channels = 384, out_channels = 500, kernel_size = 9, stride = (1,) , dilation = 1, groups = 1, bias = True)
        self.conv5 = CausalConv1d(in_channels = 256, out_channels = 500, kernel_size = 11, stride = (1,) , dilation = 1, groups = 1, bias = True)
        self.conv6 = CausalConv1d(in_channels = 128, out_channels = 500, kernel_size = 25, stride = (1,) , dilation = 1, groups = 1, bias = True)
        self.conv7 = CausalConv1d(in_channels = 128, out_channels = 500, kernel_size = 40, stride = (1,) , dilation = 1, groups = 1, bias = True)
        self.conv8 = CausalConv1d(in_channels = 128, out_channels = 500, kernel_size = 60, stride = (1,) , dilation = 1, groups = 1, bias = True)
        self.conv9 = CausalConv1d(in_channels = 128, out_channels = 500, kernel_size = 89, stride = (1,) , dilation = 1, groups = 1, bias = True)
        ...
        self.batch2 = nn.BatchNorm1d(num_features = 512, eps = 0.001, momentum = 0.99, affine = True, track_running_stats = True, device = None, dtype = None)
        self.batch3 = nn.BatchNorm1d(num_features = 384, eps = 0.001, momentum = 0.99, affine = True, track_running_stats = True, device = None, dtype = None)
        ...
        self.batch9 = nn.BatchNorm1d(num_features = 128, eps = 0.001, momentum = 0.99, affine = True, track_running_stats = True, device = None, dtype = None)
