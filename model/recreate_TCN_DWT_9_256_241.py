...
path = Path("../data/ParsedModels/NMDA_TCN__DWT_9_256_241__model/weights.json")
...
path2 = Path("../data/ParsedModels/NMDA_TCN__DWT_9_256_241__model/model.json")
...
dataFile = Path("../data/Models/NMDA_TCN__DWT_9_256_241__model.h5")
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.batch2 = nn.BatchNorm1d(num_features=512, eps=0.001, momentum=0.99,
                                     affine=True, track_running_stats=True, device=None, dtype=None)
        self.batch3 = nn.BatchNorm1d(num_features=384, eps=0.001, momentum=0.99,
                                     affine=True, track_running_stats=True, device=None, dtype=None)
        ...
        self.batch8 = nn.BatchNorm1d(num_features=128, eps=0.001, momentum=0.99,
                                     affine=True, track_running_stats=True, device=None, dtype=None)
        self.batch9 = nn.BatchNorm1d(num_features=128, eps=0.001, momentum=0.99,
                                     affine=True, track_running_stats=True, device=None, dtype=None)
...
print(f'keras weight {weights[48].shape} and Pytorch weight {net.conv9.weight.shape}')
print(f'keras weight {weights[50].shape} and Pytorch weight {net.batch9.weight.shape}')
print(f'keras weight {weights[54].shape} and Pytorch weight {net.spikes.weight.shape}')
print(f'keras weight {weights[56].shape} and Pytorch weight {net.soma.weight.shape}')
print(f'keras weight {weights[58].shape} and Pytorch weight {net.dendrites.weight.shape}')
...
net.conv9.weight.data = torch.from_numpy(np.transpose(weights[48]))
net.conv9.bias.data = torch.from_numpy(weights[49])

#Batch Layer 8
net.batch9.weight.data = torch.from_numpy(weights[50])
net.batch9.bias.data = torch.from_numpy(weights[51])
net.batch9.running_mean.data = torch.from_numpy(weights[52])
net.batch9.running_var.data = torch.from_numpy(weights[53])

#Spike Output Layer
net.spikes.weight.data = torch.from_numpy(np.transpose(weights[54]))
net.spikes.bias.data = torch.from_numpy(weights[55])

# Soma Output Layer
net.soma.weight.data = torch.from_numpy(np.transpose(weights[56]))
net.soma.bias.data = torch.from_numpy(weights[57])

#Dendrite Output Layer
net.dendrites.weight.data = torch.from_numpy(np.transpose(weights[58]))
net.dendrites.bias.data = torch.from_numpy(weights[59])
